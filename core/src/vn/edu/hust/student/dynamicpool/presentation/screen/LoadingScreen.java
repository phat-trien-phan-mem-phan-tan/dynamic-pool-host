...
import vn.edu.hust.student.dynamicpool.presentation.assets.AssetLoadFonts;
...
public class LoadingScreen implements Screen {
	...
	@Override
	public void show() {
		AssetLoadFonts loadingAssets = Assets.instance.assetFonts;
		this.bitmapFont = loadingAssets.getLagerFont();
		calculateLoadingTextPosition();
	}
